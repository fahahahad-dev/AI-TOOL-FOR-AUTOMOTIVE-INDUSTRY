...
import RenameFolderDialog from "./dialogs/rename-folder"
...
interface UploadFileTreeProps {
  data: UploadItem
  onFileSelect?: (file: UploadFile) => void
  selectedFile?: UploadFile
  title?: string
  onAddFile?: (file: UploadFile, parentPath: string) => void
  onAddFolder?: (folder: UploadFolder, parentPath: string) => void
  onDeleteFile?: (file: UploadFile, parentPath: string) => void
  onDeleteFolder?: (folder: UploadFolder, parentPath: string) => void
  onRenameFile?: (file: UploadFile, newFilename: string, newExtension: string, parentPath: string) => void
  onRenameFolder?: (folder: UploadFolder, newFolderName: string, parentPath: string) => void
}
      ...
      <SidebarContent>
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {isRootFolder ? (
                (data as UploadFolder).items.map((child, index) => (
                  <TemplateNode
                    key={index}
                    item={child}
...
function TemplateNode({
  ...
  if (!isFolder) {
    ...
    const folder = item as UploadFolder
